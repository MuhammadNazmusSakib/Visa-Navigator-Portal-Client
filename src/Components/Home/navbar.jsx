...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-600 text-white shadow-lg">
      ...
      {/* Mobile menu */}
      {isMenuOpen && (
        <div className="md:hidden bg-blue-700 space-y-2 px-6 py-4" onClick={() => setIsMenuOpen(!isMenuOpen)}>
          <div onClick={toggleTheme}>
            <label className="flex cursor-pointer gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <NavLink to={`/my-visa-applications/email`} className="block hover:underline">
            My Visa Applications
          </NavLink>
          {user ? (
